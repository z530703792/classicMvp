...
public class HorizontalProgressBar extends View {
     ...
     * 进度条背景颜色
     */
    private int bgColor = 0xFFffb96c;
    /**
     * 进度条颜色
     */
    private int progressColor = 0xFFffb96c;
...
//        initdot();
    ...
    private void initPaint() {
        bgPaint = getPaint(dp2px(2), bgColor, Paint.Style.STROKE);
    ...
    private void drawRing(Canvas canvas) {
        ...
        Path path = new Path();
        path.moveTo(getPaddingLeft(), tipHeight/2);
        path.lineTo(currentProgress, tipHeight/2);
