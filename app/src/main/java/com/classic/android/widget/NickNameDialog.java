...
public class NickNameDialog {
    ...
    public NickNameDialog setTitle(String title) {
        showTitle = true;
        if ("".equals(title)) {
    ...
    public NickNameDialog setEditText(String msg) {
        showEditText = true;
        if ("".equals(msg)) {
    ...
    public NickNameDialog setEditTextContent(String text) {
        showEditText = true;
        edittxt_result.setText(text);
        edittxt_result.setSelection(text.length());
        return this;
    }

    public NickNameDialog setEditType(int editType) {
    ...
    public NickNameDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public NickNameDialog setPositiveButton(String text,
    ...
    public NickNameDialog setNegativeButton(String text,
                                            final OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            btn_neg.setText("取消");
