...
import com.classic.base_library.widget.rebound.SimpleSpringListener;
import com.classic.base_library.widget.rebound.Spring;
import com.classic.base_library.widget.rebound.SpringConfig;
import com.classic.base_library.widget.rebound.SpringSystem;
import com.classic.base_library.widget.rebound.SpringUtil;
...
public class ToggleButton extends View {
	...
	public void setup(AttributeSet attrs) {
		...
		TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.SwitchBar);
		offBorderColor = typedArray.getColor(R.styleable.SwitchBar_offBorderColor, offBorderColor);
		onColor = typedArray.getColor(R.styleable.SwitchBar_onColor, onColor);
		spotColor = typedArray.getColor(R.styleable.SwitchBar_spotColor, spotColor);
		offColor = typedArray.getColor(R.styleable.SwitchBar_offColor, offColor);
		borderWidth = typedArray.getDimensionPixelSize(R.styleable.SwitchBar_borderWidth, borderWidth);
		defaultAnimate = typedArray.getBoolean(R.styleable.SwitchBar_animate, defaultAnimate);
		isDefaultOn = typedArray.getBoolean(R.styleable.SwitchBar_isDefaultOn, isDefaultOn);
