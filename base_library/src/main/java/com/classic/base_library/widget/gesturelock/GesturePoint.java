...
public class GesturePoint {
     ...
     */
    private int num;
    private int preDrawable;

    public GesturePoint(int leftX, int rightX, int topY, int bottomY,
                        ImageView image, int num, int pressPic) {
        super();
        this.preDrawable = pressPic;
        this.leftX = leftX;
        this.rightX = rightX;
        this.topY = topY;
    ...
    public void setPointState(int state) {
        ...
        switch (state) {
            case Constants.POINT_STATE_NORMAL:
                this.image.setImageResource(R.drawable.lock_nomarl);
                break;
            case Constants.POINT_STATE_SELECTED:
                this.image.setBackgroundResource(R.drawable.input_lock);
                break;
            case Constants.POINT_STATE_WRONG:
                this.image.setBackgroundResource(R.drawable.errer_lock);
                break;
            default:
                break;
        }
