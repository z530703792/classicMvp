...
public class LockIndicator extends View {
    ...
    public LockIndicator(Context paramContext, AttributeSet paramAttributeSet) {
        ...
        padding = DensityUtils.dp2px(getContext(),5);
        paint = new Paint();
        paint.setAntiAlias(true);
        paint.setStrokeWidth(strokeWidth);
        paint.setStyle(Paint.Style.STROKE);
        patternNoraml = getResources().getDrawable(R.drawable.index_normal);
        patternPressed = getResources().getDrawable(R.drawable.index_select);
        if (patternPressed != null) {
            ...
            patternPressed.setBounds(padding, padding, patternWidth, patternHeight);
            patternNoraml.setBounds(padding, padding, patternWidth, patternHeight);
        }
    }
